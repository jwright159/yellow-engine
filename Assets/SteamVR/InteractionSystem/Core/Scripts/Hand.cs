...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        public Transform noSteamVRFallbackAim;
        public float noSteamVRFallbackAimDistance = 2.0f;
        ...
        public void AttachObject(GameObject objectToAttach, GrabTypes grabbedWithType, AttachmentFlags flags = defaultAttachmentFlags, Transform attachmentOffset = null)
        {
            ...
            if (attachedObject.HasAttachFlag(AttachmentFlags.ParentToHand))
            {
                ...
                objectToAttach.transform.parent = this.transform; // ha ha sike you thought
        ...
        protected virtual void UpdateNoSteamVRFallback()
        {
            if (noSteamVRFallbackCamera)
            {
                ...
                noSteamVRFallbackAim.position = ray.origin + noSteamVRFallbackAimDistance * ray.direction;
                noSteamVRFallbackAim.rotation = Quaternion.LookRotation(ray.direction, Vector3.up);
